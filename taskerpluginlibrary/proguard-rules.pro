# Contents of taskerpluginlibrary/proguard-rules.pro from sample
...
-keepclasseswithmembers class * { @com.joaomgcd.taskerpluginlibrary.input.TaskerInputField <fields>; }
-keep @com.joaomgcd.taskerpluginlibrary.input.TaskerInputRoot public class *
-keepclassmembers @com.joaomgcd.taskerpluginlibrary.input.TaskerInputRoot class * { public <init>(...); }
-keep @com.joaomgcd.taskerpluginlibrary.input.TaskerInputObject public class *
-keepclassmembers @com.joaomgcd.taskerpluginlibrary.input.TaskerInputObject class * { public <init>(...); }
-keep @com.joaomgcd.taskerpluginlibrary.output.TaskerOutputObject public class *
-keepclassmembers class * { @com.joaomgcd.taskerpluginlibrary.output.TaskerOutputObject *; }
-keepclassmembers class * { @com.joaomgcd.taskerpluginlibrary.output.TaskerOutputVariable *; }
