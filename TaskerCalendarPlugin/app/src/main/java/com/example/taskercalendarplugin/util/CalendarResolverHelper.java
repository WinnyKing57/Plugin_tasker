...
public class CalendarResolverHelper {
    ...
    public List<CalendarDTO> getCalendars(Context context) {
        ...
        //     }
        // }
        Log.d(TAG, "Returning " + calendars.size() + " calendars (CalendarContract calls commented out).");
        return calendars;
    }
    ...
    public List<EventDTO> getEvents(Context context, long startTimeMillis, long endTimeMillis) {
        ...
        //     }
        // }
        Log.d(TAG, "Returning " + events.size() + " events (CalendarContract calls commented out).");
        return events;
    }
    ...
    public Uri addEvent(Context context, long calendarId, String title, String description,
        ...
        // }
        Log.d(TAG, "addEvent: CalendarContract calls commented out.");
        return eventUri;
    }
    ...
    public long getDefaultWritableCalendarId(Context context) {
        ...
        if (calendarId == -1) {
            Log.w(TAG, "Could not find any default writable calendar (CalendarContract calls commented out).");
        }
        return calendarId;
    }
}
